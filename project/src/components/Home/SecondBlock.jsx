    ...
    return (
        ...
        > 
            ...
            <div className="relative flex flex-col">
                <motion.div 
                    style={{ left: `${806 - shrinkOffset * 1.6}px`, marginBottom: dynamicMarginBottom }}
                ...
                <motion.div 
                    style={{ left: `${857 - shrinkOffset * 1.7}px`, marginBottom: dynamicMarginBottom }}
               ...
               <motion.div 
                    style={{ left: `${475 - shrinkOffset*.95}px`, marginBottom: dynamicMarginBottom }}
